...
public class ListProductAdapter extends ArrayAdapter<Product> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.list_product_adapter, parent, false);

        ImageView imageProductListItem = (ImageView) convertView.findViewById(R.id.imageProductListItem);
        TextView amountProductListItem = (TextView) convertView.findViewById(R.id.amountProductListItem);
        TextView nameProductListItem = (TextView) convertView.findViewById(R.id.nameProductListItem);
